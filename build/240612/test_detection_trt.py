...
from Utils.detection_trt import detection_ps_trt as dpt
...
if __name__ == '__main__':
    ...
    detection_obj = dpt(f'Result/{res_name}/SSIM', res_name)
    result_path, db_eval_time = detection_obj.detection_panseo_trt()
