...
# BUILD: Jun 01, 2024 (KST)
##########################################

########## Change Log ##########
# Jun 01, 2024 (KST)
# Change tiny freeze size: 50 -> 28
# Change epochs: 100 -> 200
    ...
    if(mysel == '1'):
        if(sel_model == '1'):
            ...
            if(torch.backends.mps.is_available()):
                os.system("python train.py --workers 1 --device mps --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt --freeze 50")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt --freeze 50")
        else:
            print("Training the yolov7-tiny model...")
            if(torch.backends.mps.is_available()):
                os.system("python train.py --workers 1 --device mps --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt --freeze 28")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt --freeze 28")
    ## Not Freeze
    else:
        if(sel_model == '1'):
            print("Training the yolov7 model...")
            if(torch.backends.mps.is_available()):
                os.system("python train.py --workers 1 --device mps --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt")
        else:
            print("Training the yolov7-tiny model...")
            if(torch.backends.mps.is_available()):
                os.system("python train.py --workers 1 --device mps --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt")
    ...
    if(mysel == '1'):
        if(sel_model == '1'):
            ...
            if(torch.cuda.is_available()):
                os.system("python train.py --workers 1 --device 0 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt --freeze 50")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt --freeze 50")
        else:
            print("Training the yolov7-tiny model...")
            if(torch.cuda.is_available()):
                os.system("python train.py --workers 1 --device 0 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt --freeze 28")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt --freeze 28")
    else:
        if(sel_model == '1'):
            print("Training the yolov7 model...")
            if(torch.cuda.is_available()):
                os.system("python train.py --workers 1 --device 0 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-custom.yaml --name yolov7-custom --weights yolov7.pt")
        else:
            print("Training the yolov7-tiny model...")
            if(torch.cuda.is_available()):
                os.system("python train.py --workers 1 --device 0 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt")
            else:
                os.system("python train.py --workers 1 --batch-size 16 --epochs 200 --img 640 640 --data data/GRIKDataset/data.yaml --hyp data/hyp.scratch.custom.yaml --cfg cfg/training/yolov7-tiny-custom.yaml --name yolov7-tiny-custom --weights yolov7-tiny.pt")
    print("Training is done.")
